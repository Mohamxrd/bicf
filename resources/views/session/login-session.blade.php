          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                ...
                <small class="text-muted">Mot de passe oublié ?
                  <a href="/login/forgot-password" class="text-info text-gradient font-weight-bold">Cliquez ici</a>
                </small>
                  <p class="mb-4 text-sm mx-auto">
                    Vous n'avez pas de compte ?
                    <a href="register" class="text-info text-gradient font-weight-bold">Créer un compte</a>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('../assets/img/bg1.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
